...
include($arquivoPath);
     ...
     $numEstacoes = 11;
       ...
       function insere2($dia, $mes, $ano, $tempAr,$eto, $radSol, $velVento,$umidRel, $codigo, $idCidade) {
       
                            $ins = ""; 
                            if( $tempAr > -9 && $eto > -40 ) {

                                  $ins = "insert into evapoTranspiracaoTomateEstacao(dia, mes, ano, temMedia, eto, radsol, velVento, ur, codEstacao, idCidade, validado) values($dia, $mes, $ano, $tempAr, $eto, $radSol, $velVento,$umidRel, $codigo, $idCidade, 1 );";
       ...
       } // final de function insere2($dia...

        function update2($id, $tempAr,$eto,$radSol,$velVento, $umidRel) {
                            ...
                            if( $tempAr > -9 && $eto > -40 ) {
                                  ...
                                  $upd = $upd."update evapoTranspiracaoTomateEstacao set ur = $umidRel where id = $id;";
                                  $upd = $upd."update evapoTranspiracaoTomateEstacao set radSol = $radSol where id = $id;";
                                  $upd = $upd."update evapoTranspiracaoTomateEstacao set velVento = $velVento where id = $id;";
...
//echo "<br>$upd1<br>$upd2<br>$upd3<br>$upd4<br>$upd5<br>$upd6";
                  ...
                  if( strcmp($upd4,"000") )
                      $query2 = mysqli_query($conexao, $upd4);
                  if( strcmp($upd5,"000") )
                      $query2 = mysqli_query($conexao, $upd5);
                  if( strcmp($upd6,"000") )
                      $query2 = mysqli_query($conexao, $upd6);
