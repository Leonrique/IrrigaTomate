...
function cadastro(nome, email, user, senha) {
    ...
    xmlHttpObject.onreadystatechange = mostraSaidaCadastro; //especifica a funcao JAVASCRIPT que recebera o resultado
	        ...
	        if (xmlHttpObject.status == 200) {
              ...
              if (texto3 == "4") {
                 ...
                 if (texto3 == "1") {
                    ...
                    alert("codigo -> " + texto3 + "\n\nEste usuário ou e-mail já foi cadastrado anteriormente.");
                 } else if (texto3 == "2") {
