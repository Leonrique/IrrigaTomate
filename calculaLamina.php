    ...
    if($estacao != ""){
     ...
     if(!$query) {
          ...
          if( $numLinhas > 0) {
             ...
             $registroInicial =  '<tr><td>'.$dia.'/'.$mesNovo[(int)$mes].'</td><td>0</td><td>'.$eto2.'</td><td>--</td><td><td>';
             $registroInicial = $registroInicial . '<input type = text value = 15.00 size = 10 style = " color:green; border: none transparent; background: transparent; outline: none;  padding-left:9px; font-size: 16px;" readonly  onclick="atualizaDados(0)" onblur="atualizaDados(5)"   onkeyup="inputKeyUp(event)"  ></td><td>';
             $registroInicial = $registroInicial . '<input type = text value = '.$lamina.' size = 10 class="deadInput" readonly  onclick="atualizaDados(0)" onblur="atualizaDados(5)"   onkeyup="inputKeyUp(event)"  ></td><td>';
             $registroInicial = $registroInicial . '<input type = text value = "" size = 10 class="deadInput" readonly  onclick="atualizaDados(0)" onblur="atualizaDados(5)"   onkeyup="inputKeyUp(event)"  ></td>';            
             $registroInicial = $registroInicial . '<input type = text value = "" size = 10 class="deadInput" readonly  onclick="atualizaDados(0)" onblur="atualizaDados(5)"   onkeyup="inputKeyUp(event)"  ></td></tr>';
     ...
     $sql= "select dia, mes, temMedia, eto, ifnull(codEstacao, '') codEstacao
            from evapoTranspiracaoTomateEstacao
...
//
               ...
               echo '
                 ...
                 <!-- box do conteudo-->
                  ...
                  <col style="width: 12%; background-color:#e8f0d9;">
                  <col style="width: 12%; background-color:#fff;">
                  <col style="width: 10%; background-color:#e8f0d9;">
                  <col style="width: 10%; background-color:#e8f0d9;">
                   </colgroup>
                     <tr>
                       <th >Data</th>
