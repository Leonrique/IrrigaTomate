        ...
        function getDadosClimaticos(id) {
              ...
              xmlHttpObject.open('GET','getDadosClimaticos.php?id=' + id ); 
                ...
                if (xmlHttpObject.status == 200) {
                    ...
                    if(newTexto.length > 3 ) {
                             ...
                             for( i = 0; i < results.length; i++ ) {
                                  ...
                                  tabela = tabela + "<tr><td>" + string[0] + "</td><td>" + string[1] + "</td><td>" + string[2] + "</td><td style=\" padding-left:15px\">" + tempMedia.toFixed(2) + "</td><td>" + somaTermica.toFixed(2) + "</td><td>" + etoMedia.toFixed(2) + "</td><td>" + string[5] + "</td><td>" + string[6] + "</td><td>" + string[7] + "</td></tr>" ;
